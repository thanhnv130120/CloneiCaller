...
import com.example.cloneicaller.databinding.DisplayAfterCall4Binding;

public class DialogDisplayAfterCall4 extends Service {

    //Thanhnv
    DisplayAfterCall4Binding binding;
    ...
    private void createDialog() {
        ...
        View view = View.inflate(this, R.layout.display_after_call_4, groupView);

        ImageView btnClose = view.findViewById(R.id.imgCloseAfterCall4);
